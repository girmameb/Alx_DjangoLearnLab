...
urlpatterns = [
    ...
    path('books/<int:pk>/', BookDetailView.as_view(), name='book-detail'),  # Retrieve, update, or delete a specific book
    path('books/<int:pk>/update/', BookUpdateView.as_view(), name='book-update'),  # Explicit update URL
    path('books/<int:pk>/delete/', BookDeleteView.as_view(), name='book-delete'),  # Explicit delete URL
]
